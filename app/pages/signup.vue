    ...
    <form class="form w-full relative sm:w-[550px] rounded-md space-y-4 py-6 px-3 md:p-10 bg-white/30 backdrop-blur-lg">
      ...
      <div class="flex items-center border-b-2 border-emerald-200 w-full">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#93C572" class="w-7 h-7 mr-3">
          <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9a3 3 0 11-6 0 3 3 0 016 0zM2.25 21v-2.25a4.5 4.5 0 014.5-4.5h10.5a4.5 4.5 0 014.5 4.5V21" />
        </svg>
        <input v-model="name" type="text" placeholder="Full Name" class="w-[95%] py-4 text-slate-700 placeholder-[#93C572] bg-transparent focus:outline-none text-xl" />
      </div>
      ...
      <div class="flex items-center border-b-2 border-emerald-200 w-full">
        ...
        <input v-model="email" type="email" placeholder="Email" class="w-[95%] py-4 text-slate-700 placeholder-[#93C572] bg-transparent focus:outline-none text-xl" />
      </div>
      ...
      <div class="flex items-center border-b-2 border-emerald-200 w-full focus-within:border-emerald-400 transition relative">
        ...
        <input :type="showPassword ? 'text' : 'password'" v-model="password" placeholder="Password" class="w-[95%] py-3 text-slate-800 placeholder-[#93C572] bg-transparent focus:outline-none text-xl" />
